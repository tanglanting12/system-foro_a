...
DATABASES = {
    'default': {
        ...
        'NAME': ConfigDBNames.oa,                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': ConfigMysql.user_name,
        'PASSWORD': ConfigMysql.password,
        'HOST': ConfigMysql.host,                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
MEDIA_ROOT = osp.join(PROJECT_ROOT, 'uploads')
...
SECRET_KEY = 'wru#3h*)#^o*$6d*bg7oep_$6*9k3vp&c0c^ua_pbqkxayh_r('
...
GRAPPELLI_ADMIN_TITLE = 'Nubia表情管理系统'
