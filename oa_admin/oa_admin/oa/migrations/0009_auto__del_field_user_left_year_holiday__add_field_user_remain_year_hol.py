...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.left_year_holiday'
        db.delete_column(u'oa_user', 'left_year_holiday')

        # Adding field 'User.remain_year_holiday'
        db.add_column(u'oa_user', 'remain_year_holiday',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=8),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'User.left_year_holiday'
        db.add_column(u'oa_user', 'left_year_holiday',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=8),
                      keep_default=False)

        # Deleting field 'User.remain_year_holiday'
        db.delete_column(u'oa_user', 'remain_year_holiday')
