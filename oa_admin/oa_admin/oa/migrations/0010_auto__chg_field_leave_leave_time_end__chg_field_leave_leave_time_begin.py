...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Leave.leave_time_end'
        db.alter_column(u'oa_leave', 'leave_time_end', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Leave.leave_time_begin'
        db.alter_column(u'oa_leave', 'leave_time_begin', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Leave.leave_time_end'
        db.alter_column(u'oa_leave', 'leave_time_end', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Leave.leave_time_begin'
        db.alter_column(u'oa_leave', 'leave_time_begin', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
